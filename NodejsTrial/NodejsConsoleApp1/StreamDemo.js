...
function zlib_file() {
    ...
    var fs = require('fs');
    var inFile = fs.createReadStream('UtilDemo.js');
    var outFile = fs.createWriteStream('UtilDemo.gz');

    inFile.pipe(gzip).pipe(outFile);

    setTimeout(function () {
        var gunzip = zlib.createUnzip({ flush: zlib.Z_FULL_FLUSH });
        var inFile = fs.createReadStream('UtilDemo.gz');
        var outFile = fs.createWriteStream('UtilDemo.unzipped');
